...
from keras_sequence_classfication.models import build_stateful_lstm_model,build_stateful_lstm_model_with_normalization
from keras_sequence_classfication.data import dataSet
from keras.callbacks import TensorBoard

import numpy as np

data = dataSet(force_update=True,sample_skip_num=50)
MODEL_PATH = 'model_skip_%s_normalization.dat'%(data.sample_skip_num)
